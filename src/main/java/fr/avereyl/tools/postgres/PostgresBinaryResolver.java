...
public interface PostgresBinaryResolver {
	...
	/**
	 * Returns an input stream with the postgres binary for the given system and
	 * hardware architecture.
	 * 
	 * @param system
	 *            a system identification (Darwin, Linux...)
	 * @param machineHardware
	 *            a machine hardware architecture (x86_64...)
	 * @return the binary
	 */
